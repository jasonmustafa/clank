...
export interface DiscordTransport { createThread(requestId: string, name: string): Promise<string>; send(channelId: string, content: string, options?: { kind?: "preview" | "status" | "final"; files?: readonly string[] }): Promise<string | undefined>; updatePreview(channelId: string, content: string): Promise<void>; setTyping(channelId: string, active: boolean): Promise<void>; }
